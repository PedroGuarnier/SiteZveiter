...
Final version: Correct class names
"""
...
def combine_files(redesign_path, original_path, output_path):
    ...
    sidebar = page_content.find('aside', class_='sidebar')
    if sidebar:
        print("Updating sidebar navigation...")
        sidebar_nav = sidebar.find('ul', class_='sidebar-nav')
        if sidebar_nav:
            sidebar_nav.clear()

            # Build new sidebar items
            nav_html = f'''<li>
                        <a class="active" href="#" onclick="showPanel('informativos', this); return false;">
                            Informativos
            ...
            sidebar_nav.append(BeautifulSoup(nav_html, 'html.parser'))

    # Find and update the main content area
    doc_panels = page_content.find('div', class_='doc-panels')
    if doc_panels:
        ...
        info_panel = BeautifulSoup(
            '''<div class="doc-panel active" id="panel-informativos">
                    <div class="panel-header">
                        <h2 class="panel-title">Informativos</h2>
                        <span class="panel-count"> documentos</span>
                    </div>
                    <div class="doc-list">
                    </div>
                </div>''',
        ...
        doc_panels.append(info_panel)

        # Editais panel
        if sections.get('EDITAIS'):
            print("  - Building editais panel...")
            editais_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-editais">
                        <div class="panel-header">
                            <h2 class="panel-title">Editais</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(editais_panel)

        # Relação de Credores panel
        if sections.get('RELAÇÃO DE CREDORES'):
            print("  - Building relação de credores panel...")
            relacao_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-relacao-credores">
                        <div class="panel-header">
                            <h2 class="panel-title">Relação de Credores</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(relacao_panel)

        # Avisos panel
        if sections.get('AVISOS'):
            print("  - Building avisos panel...")
            avisos_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-avisos">
                        <div class="panel-header">
                            <h2 class="panel-title">Avisos</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(avisos_panel)

        # Ação Civil Pública panel
        if sections.get('AÇÃO CIVIL PÚBLICA'):
            print("  - Building ação civil pública panel...")
            acao_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-acao-civil-publica">
                        <div class="panel-header">
                            <h2 class="panel-title">Ação Civil Pública</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(acao_panel)

        # Tutela Cautelar panel
        if sections.get('TUTELA CAUTELAR ANTECEDENTE À RECUPERAÇÃO JUDICIAL'):
            print("  - Building tutela cautelar panel...")
            tutela_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-tutela-cautelar">
                        <div class="panel-header">
                            <h2 class="panel-title">Tutela Cautelar Antecedente</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(tutela_panel)

        # Decisões Judiciais panel
        if sections.get('DECISÕES JUDICIAIS'):
            print("  - Building decisões judiciais panel...")
            decisoes_panel = BeautifulSoup(
                '''<div class="doc-panel" id="panel-decisoes">
                        <div class="panel-header">
                            <h2 class="panel-title">Decisões Judiciais</h2>
                            <span class="panel-count"> documentos</span>
                        </div>
                        <div class="doc-list">
                        </div>
            ...
            doc_panels.append(decisoes_panel)
